...
import { getEventos, ReadProyecto } from './crud';
...
import { Aplicacion, Compilacion, CreateProyecto, Reporte } from './modal';
...
function Calendario() {
  ...
  useEffect(() => {
    setDatos(evento.filter(row => row.id_proyecto === selectProyecto));
        ...
        <div className='cont__calendario'>
          <div className='head'>
            ...
            <div className="proyecto">
              <h1>Proyecto:</h1>
              <select className="select_p" name='prueba' value={selectProyecto} onChange={(e) => setSelectProyecto(e.target.value)}>
